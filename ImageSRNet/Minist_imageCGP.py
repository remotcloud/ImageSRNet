...
def evolutionNAddLamdaCommon(evlutionParam, input, target, file, run_num, item, Individual):
    ...
    n_input = evlutionParam.channels_list[0]
    n_output = evlutionParam.channels_list[-1]

    input_sizes = evlutionParam.input_sizes
    output_sizes = evlutionParam.output_sizes
    params = evlutionParam.params
    genNum = evlutionParam.genNum
